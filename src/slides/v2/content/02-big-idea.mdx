export const meta = {
  id: 'v2-big-idea',
  title: 'Prompted, not Coded',
};

<Compare layout="split" headline="What used to take a textbook now takes a sentence.">

<Code language="three.js" label="Old way" caption="≈ 90 lines just to see a spinning shape.">
