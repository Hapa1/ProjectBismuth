import{r as i,c as W,j as n,C as X,E as H,l as U,b as C,o as k,S as B,D as z,A as K,V as T,e as q,k as O,R as Z}from"./index-CuS_Sl1Z.js";const Y="_root_1nra7_1",J="_canvasHost_1nra7_17",Q="_panel_1nra7_27",ee="_panelTitle_1nra7_61",ne="_subtitle_1nra7_77",re="_section_1nra7_91",te="_sectionTitle_1nra7_95",ae="_row_1nra7_111",oe="_label_1nra7_127",se="_value_1nra7_129",ie="_slider_1nra7_133",le="_audioGrid_1nra7_147",ce="_button_1nra7_161",ue="_buttonActive_1nra7_193",me="_fileLabel_1nra7_205",de="_fileInput_1nra7_207",fe="_meters_1nra7_211",pe="_meter_1nra7_211",ve="_meterLabel_1nra7_229",he="_meterBar_1nra7_243",ge="_meterFill_1nra7_257",a={root:Y,canvasHost:J,panel:Q,panelTitle:ee,subtitle:ne,section:re,sectionTitle:te,row:ae,label:oe,value:se,slider:ie,audioGrid:le,button:ce,buttonActive:ue,fileLabel:me,fileInput:de,meters:fe,meter:pe,meterLabel:ve,meterBar:he,meterFill:ge},D=`// Apex vertex shader — inverted pyramid with bass-driven outward breathing.\r
\r
...
`,be=`// Apex fragment shader — luminescent iridescent mirage. The pyramid surface\r
...
`,xe=`// Apex bleed shader — pyramid surface lit only by pointer + audio-pulse\r
...
`,M=8,ye=[{id:"rings",label:"Rings"},{id:"bloom",label:"Bloom"},{id:"streaks",label:"Streaks"},{id:"sparkle",label:"Sparkle"}],F={rings:0,bloom:1,streaks:2,sparkle:3};function we(){const[p,c]=i.useState(!1);return i.useEffect(()=>{const v=window.matchMedia("(prefers-reduced-motion: reduce)"),r=()=>c(v.matches);return r(),v.addEventListener("change",r),()=>v.removeEventListener("change",r)},[]),p}const L={mode:"bleed",bleedEffect:"rings",audioGain:1.2,smoothing:.34,rotationSpeed:.25,reactivity:1,bloomIntensity:.7,zoom:12,beatThreshold:1.32,fadeDecay:1.3,mirageFloor:.06,pulseRadius:2.6,pulseDecay:1.2,pointerRadius:1.6};function P({label:p,min:c,max:v,step:r,value:o,onChange:s,format:m}){const h=m?m(o):o.toFixed(2);return n.jsxs("div",{className:a.row,children:[n.jsx("span",{className:a.label,children:p}),n.jsx("span",{className:a.value,children:h}),n.jsx("input",{type:"range",className:a.slider,min:c,max:v,step:r,value:o,onChange:e=>s(Number(e.target.value))})]})}const N=.75;function Pe(){return{pointer:{world:new T(0,0,0),strength:N,targetStrength:N},pulses:[]}}function _e({sharedRef:p,meshRef:c}){const{camera:v,gl:r}=q(),o=i.useRef(new O(0,0)),s=i.useMemo(()=>new Z,[]);return i.useEffect(()=>{const m=r.domElement,h=t=>{const u=m.getBoundingClientRect();o.current.set((t.clientX-u.left)/u.width*2-1,-((t.clientY-u.top)/u.height*2-1)),p.current.pointer.targetStrength=1},e=()=>{p.current.pointer.targetStrength=N};return m.addEventListener("pointermove",h),m.addEventListener("pointerleave",e),m.addEventListener("pointercancel",e),()=>{m.removeEventListener("pointermove",h),m.removeEventListener("pointerleave",e),m.removeEventListener("pointercancel",e)}},[r,p]),C((m,h)=>{s.setFromCamera(o.current,v);const e=c.current;if(e){const l=s.intersectObject(e,!1);l.length>0&&p.current.pointer.world.copy(l[0].point)}const t=1-Math.exp(-h*6),u=p.current.pointer;u.strength+=(u.targetStrength-u.strength)*t}),null}function Se({zoom:p}){return C((c,v)=>{const r=1-Math.exp(-v*6),o=c.camera;o.position.x+=(0-o.position.x)*r,o.position.y+=(.6-o.position.y)*r,o.position.z+=(p-o.position.z)*r,o.lookAt(0,0,0)}),null}function Me({bandsRef:p,controls:c,reduceMotion:v}){const r=i.useRef(null),o=i.useRef(0),s=i.useRef(0),m=i.useRef(999),h=i.useRef(0),e=i.useRef(0),t=i.useMemo(()=>{const l=new k(1,2,4,1);return l.rotateX(Math.PI),l},[]),u=i.useMemo(()=>new B({vertexShader:D,fragmentShader:be,uniforms:{uTime:{value:0},uMirage:{value:0},uTreble:{value:0},uMid:{value:0},uLevel:{value:0}},transparent:!0,depthWrite:!1,blending:K,side:z}),[]);return i.useEffect(()=>()=>{t.dispose(),u.dispose()},[t,u]),C((l,E)=>{const g=Math.min(E,.05),d=p.current,f=c.reactivity;d.bass>s.current?s.current=d.bass:s.current=Math.max(d.bass,s.current-g*4.5),o.current=o.current*.985+d.bass*.015,m.current+=g,h.current+=g;const _=d.bass>.08&&s.current>o.current*c.beatThreshold&&m.current>.16,S=!_&&h.current>1.1&&d.level>.05;if(_||S){m.current=_?0:m.current,h.current=0;const y=_?Math.max(d.bass,s.current-o.current):d.level*.7,A=Math.min(1.3,.7+y*f*1.6);e.current=Math.max(e.current,A)}const j=c.mirageFloor,R=Math.max(0,e.current-j);if(e.current=j+R*Math.exp(-g*c.fadeDecay),u.uniforms.uTime.value+=g,u.uniforms.uMirage.value=e.current,u.uniforms.uTreble.value=d.treble*f,u.uniforms.uMid.value=d.mid*f,u.uniforms.uLevel.value=d.level*f,!v&&r.current){const y=1+d.level*1.4;r.current.rotation.y+=g*c.rotationSpeed*y,r.current.rotation.x=Math.sin(u.uniforms.uTime.value*.3)*.06}}),n.jsx("mesh",{ref:r,geometry:t,material:u})}function Ee({bandsRef:p,controls:c,reduceMotion:v}){const r=i.useRef(null),o=i.useRef(0),s=i.useRef(0),m=i.useRef(999),h=i.useRef(0),e=i.useRef(Math.random()),t=i.useRef(Pe()),u=i.useMemo(()=>{const g=new k(1,2,4,1);return g.rotateX(Math.PI),g},[]),l=i.useMemo(()=>{const g=new Array(M).fill(0).map(()=>new T),d=new Float32Array(M),f=new Float32Array(M),x=new Float32Array(M);return new B({vertexShader:D,fragmentShader:xe,uniforms:{uTime:{value:0},uIntensity:{value:c.reactivity},uPointer:{value:new T},uPointerStrength:{value:0},uPointerRadius:{value:c.pointerRadius},uPulseCount:{value:0},uPulsePos:{value:g},uPulseI:{value:d},uPulseHue:{value:f},uPulseAge:{value:x},uPulseTravel:{value:c.pulseRadius},uEffect:{value:F[c.bleedEffect]}},side:z})},[]);i.useEffect(()=>{l.uniforms.uIntensity.value=c.reactivity,l.uniforms.uPointerRadius.value=c.pointerRadius,l.uniforms.uPulseTravel.value=c.pulseRadius,l.uniforms.uEffect.value=F[c.bleedEffect]},[c,l]),i.useEffect(()=>()=>{u.dispose(),l.dispose()},[u,l]);const E=g=>{const d=r.current;if(!d)return;const f=Math.random()*Math.PI*2,x=Math.pow(Math.random(),.7),_=x,S=-1+2*x,R=new T(Math.cos(f)*_,S,Math.sin(f)*_).applyMatrix4(d.matrixWorld),y=t.current.pulses;y.length>=M&&y.shift(),e.current=(e.current+.31)%1,y.push({pos:R,intensity:g,hue:e.current,age:0,lifetime:.85+Math.random()*.4})};return C((g,d)=>{const f=Math.min(d,.05),x=p.current;x.bass>s.current?s.current=x.bass:s.current=Math.max(x.bass,s.current-f*4.5),o.current=o.current*.985+x.bass*.015,m.current+=f,h.current+=f;const S=x.bass>.08&&s.current>o.current*c.beatThreshold&&m.current>.14,j=!S&&h.current>.9&&x.level>.06;if(S||j){m.current=S?0:m.current,h.current=0;const b=S?Math.max(x.bass,s.current-o.current):x.level*.7,w=Math.min(2.2,.5+b*1.8);E(w)}const R=c.pulseDecay,y=t.current.pulses;for(let b=y.length-1;b>=0;b-=1){const w=y[b];w.age+=f/Math.max(w.lifetime,.05),w.intensity-=R*f*.4,(w.age>=1||w.intensity<=0)&&y.splice(b,1)}const A=Math.min(y.length,M),I=l.uniforms.uPulsePos.value,$=l.uniforms.uPulseI.value,G=l.uniforms.uPulseHue.value,V=l.uniforms.uPulseAge.value;for(let b=0;b<A;b+=1){const w=y[b];I[b].copy(w.pos),$[b]=w.intensity,G[b]=w.hue,V[b]=Math.min(1,w.age)}if(l.uniforms.uPulseCount.value=A,l.uniforms.uTime.value+=f,l.uniforms.uPointer.value.copy(t.current.pointer.world),l.uniforms.uPointerStrength.value=t.current.pointer.strength,!v&&r.current){const b=1+x.level*1.4;r.current.rotation.y+=f*c.rotationSpeed*b,r.current.rotation.x=Math.sin(l.uniforms.uTime.value*.3)*.06}}),n.jsxs(n.Fragment,{children:[n.jsx(_e,{sharedRef:t,meshRef:r}),n.jsx("mesh",{ref:r,geometry:u,material:l})]})}function Re({width:p,height:c}){const v=we(),[r,o]=i.useState(L),s=W(),m=i.useRef(null);i.useEffect(()=>{s.setGain(r.audioGain)},[s,r.audioGain]),i.useEffect(()=>{s.setSmoothing(r.smoothing)},[s,r.smoothing]),i.useEffect(()=>{let e=0;const t=()=>{const u=m.current;if(u){const l=s.bands.current,E=u.querySelectorAll(`.${a.meterFill}`),g=[l.bass,l.mid,l.treble,l.level];E.forEach((d,f)=>{d.style.width=`${Math.min(100,g[f]*130)}%`})}e=requestAnimationFrame(t)};return e=requestAnimationFrame(t),()=>cancelAnimationFrame(e)},[s.bands]);const h=e=>{var u;const t=(u=e.target.files)==null?void 0:u[0];t&&s.loadFile(t),e.target.value=""};return n.jsxs("div",{className:a.root,style:{width:p,height:c},children:[n.jsxs(X,{className:a.canvasHost,camera:{position:[0,.6,L.zoom],fov:35},gl:{antialias:!0,powerPreference:"high-performance"},dpr:[1,Math.min(window.devicePixelRatio,2)],children:[n.jsx(Se,{zoom:r.zoom}),r.mode==="mirage"?n.jsx(Me,{bandsRef:s.bands,controls:r,reduceMotion:v}):n.jsx(Ee,{bandsRef:s.bands,controls:r,reduceMotion:v}),n.jsx(H,{children:n.jsx(U,{intensity:r.bloomIntensity,luminanceThreshold:.15,luminanceSmoothing:.6,mipmapBlur:!0,radius:.7})})]}),n.jsxs("aside",{className:a.panel,"aria-label":"Apex controls",children:[n.jsx("h3",{className:a.panelTitle,children:"Apex · Inverted Pyramid"}),n.jsx("p",{className:a.subtitle,children:r.mode==="mirage"?"A luminescent iridescent mirage. The pyramid surfaces from the dark on every beat, then fades back into haze.":"Voronoi-style pointer + audio-pulse spotlights bleed iridescent light across the pyramid surface."}),n.jsxs("section",{className:a.section,children:[n.jsx("p",{className:a.sectionTitle,children:"Mode"}),n.jsxs("div",{className:a.audioGrid,children:[n.jsx("button",{type:"button",className:`${a.button} ${r.mode==="mirage"?a.buttonActive:""}`,onClick:()=>o(e=>({...e,mode:"mirage"})),children:"Mirage"}),n.jsx("button",{type:"button",className:`${a.button} ${r.mode==="bleed"?a.buttonActive:""}`,onClick:()=>o(e=>({...e,mode:"bleed"})),children:"Bleed Lights"})]})]}),n.jsxs("section",{className:a.section,children:[n.jsx("p",{className:a.sectionTitle,children:"Audio Source"}),n.jsxs("div",{className:a.audioGrid,children:[n.jsx("button",{type:"button",className:`${a.button} ${s.source==="demo"?a.buttonActive:""}`,onClick:()=>void s.loadDemo(),children:"Demo Pad"}),n.jsx("button",{type:"button",className:`${a.button} ${s.source==="mic"?a.buttonActive:""}`,onClick:()=>void s.enableMic(),children:"Microphone"}),n.jsx("button",{type:"button",className:`${a.button} ${s.source==="tab"?a.buttonActive:""}`,onClick:()=>{s.captureTab().catch(e=>{const t=e instanceof Error?e.message:String(e);window.alert(`Tab audio capture failed:

${t}`)})},children:"Tab Audio"}),n.jsxs("label",{className:`${a.button} ${a.fileLabel} ${s.source==="file"?a.buttonActive:""}`,children:["Load File",n.jsx("input",{className:a.fileInput,type:"file",accept:"audio/*",onChange:h})]}),n.jsx("button",{type:"button",className:a.button,onClick:()=>s.stop(),disabled:!s.isActive,children:"Stop"})]}),n.jsx("div",{className:a.meters,ref:m,children:["BASS","MID","TREBLE","LEVEL"].map(e=>n.jsxs("div",{className:a.meter,children:[n.jsx("span",{className:a.meterLabel,children:e}),n.jsx("span",{className:a.meterBar,children:n.jsx("span",{className:a.meterFill})})]},e))})]}),n.jsxs("section",{className:a.section,children:[n.jsx("p",{className:a.sectionTitle,children:"Audio"}),n.jsx(P,{label:"Audio Gain",min:0,max:1.5,step:.01,value:r.audioGain,onChange:e=>o(t=>({...t,audioGain:e}))}),n.jsx(P,{label:"Smoothing",min:0,max:.96,step:.01,value:r.smoothing,onChange:e=>o(t=>({...t,smoothing:e}))}),n.jsx(P,{label:"Reactivity",min:0,max:2.5,step:.05,value:r.reactivity,onChange:e=>o(t=>({...t,reactivity:e}))}),n.jsx(P,{label:"Beat Threshold",min:1.05,max:2,step:.01,value:r.beatThreshold,onChange:e=>o(t=>({...t,beatThreshold:e}))})]}),n.jsxs("section",{className:a.section,children:[n.jsx("p",{className:a.sectionTitle,children:"Visuals"}),n.jsx(P,{label:"Zoom",min:3,max:30,step:.1,value:r.zoom,onChange:e=>o(t=>({...t,zoom:e})),format:e=>e.toFixed(1)}),n.jsx(P,{label:"Rotation Speed",min:0,max:1,step:.01,value:r.rotationSpeed,onChange:e=>o(t=>({...t,rotationSpeed:e}))}),r.mode==="mirage"&&n.jsxs(n.Fragment,{children:[n.jsx(P,{label:"Fade Decay",min:.3,max:4,step:.05,value:r.fadeDecay,onChange:e=>o(t=>({...t,fadeDecay:e}))}),n.jsx(P,{label:"Mirage Floor",min:0,max:.4,step:.01,value:r.mirageFloor,onChange:e=>o(t=>({...t,mirageFloor:e}))})]}),r.mode==="bleed"&&n.jsxs(n.Fragment,{children:[n.jsx("div",{className:a.row,children:n.jsx("span",{className:a.label,children:"Effect"})}),n.jsx("div",{className:a.audioGrid,children:ye.map(e=>n.jsx("button",{type:"button",className:`${a.button} ${r.bleedEffect===e.id?a.buttonActive:""}`,onClick:()=>o(t=>({...t,bleedEffect:e.id})),children:e.label},e.id))}),n.jsx(P,{label:"Pulse Radius",min:.5,max:6,step:.05,value:r.pulseRadius,onChange:e=>o(t=>({...t,pulseRadius:e}))}),n.jsx(P,{label:"Pulse Decay",min:.2,max:4,step:.05,value:r.pulseDecay,onChange:e=>o(t=>({...t,pulseDecay:e}))}),n.jsx(P,{label:"Pointer Radius",min:.3,max:4,step:.05,value:r.pointerRadius,onChange:e=>o(t=>({...t,pointerRadius:e}))})]}),n.jsx(P,{label:"Bloom",min:0,max:2.5,step:.05,value:r.bloomIntensity,onChange:e=>o(t=>({...t,bloomIntensity:e}))})]})]})]})}export{Re as default};
